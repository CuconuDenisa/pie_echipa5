...
<form action="analize.php" method="post">
	<h1> Inserare biochimie:</h1>	
		...
		<input style="background-color:white;color:black;width:70px;" type="submit" name="inserarebiochimie" class="button" value="Inserează Analize"/>	
		<br/>
		...
		<input style="background-color:white;color:black;width:70px;" type="submit" name="inserareanalize" class="button" value="Inserează Analize"/>	
		<br/>
