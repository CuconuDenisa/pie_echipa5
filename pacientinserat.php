...
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form action="pacientinserat.php" method="post">
                    ...
                    &nbsp; &nbsp;
                    <input style="background-color:white;color:black;width:70px;" type="submit" name="Adaugati_pacient"
                           class="button" value="Inserează"/>
    ...
    VALUES (default,?,?,?,?,?,?,?,?,?,?,?)";
                        ...
                        echo 'Pacient inserata cu succes';
                        echo '</script>';
                    }
                }
                ?>
                ...
                if (isset($_POST['Stergeti_pacient'])) {
                    try {
                        $pdoConnect = new PDO("mysql:host=localhost;dbname=nininexloc_pie", "nininexloc_pie", "L~%XIZCefEeZ");
                ...
                <form action="pacientinserat.php" method="post">
                    ...
                    <input style="background-color:white;color:black;width:70px;" type="submit" name="Stergeti_pacient"
                           class="button" value="Șterge"/>
                </form>
                <br>

                Diagrama:
                <form action="diagrama.php" class="inline">
                    <button class="float-left submit-button" style="background-color:white;color:black;width:70px;">
                        Diagrama
                    </button>
                </form>
                <br>
