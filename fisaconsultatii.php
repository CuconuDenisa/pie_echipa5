...
<form action="fisaconsultatie.php" method="post">
		...
		<input style="background-color:white;color:black;width:70px;" type="submit" name="fisaconsultatie" class="button" value="Inserează fisa consultatie"/>		
	</form>	
<?php
