...
?>
    ...
    <section class="dishes">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="aligncenter"><h2 class="aligncenter">Servicii 24/7</h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident, <br/>doloribus omnis minus ovident, doloribus omnis minus temporibus perferendis nesciunt..</div>
                    <br/>
                </div>
            </div>
                ...
                <div class="col-md-4 md-margin-bottom-40">
                    <div class="card small">
                        <div class="card-image">
                            ...
                            <span class="card-title">Consult medical</span>
                        </div>
                ...
                <div class="col-md-4 md-margin-bottom-40">
                    <div class="card small">
                        <div class="card-image">
                            ...
                            <span class="card-title">Analize rapide</span>
                        </div>
                        <div class="card-content">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt
                ...
                <div class="col-md-4 md-margin-bottom-40">
                    <div class="card small">
                        <div class="card-image">
                            ...
                            <span class="card-title">Programare online</span>
                        </div>
                        <div class="card-content">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt
    ...
    <section id="content">
        <div class="container">
            ...
            <section class="services">
                <div class="row">
                    <div class="col-md-12">
                        <div class="aligncenter"><h2 class="aligncenter">Calitatile noastre</h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident, <br/>doloribus omnis minus ovident, doloribus omnis minus temporibus perferendis nesciunt..</div>
                        <br/>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="about-text">
                        ...
                        <a href="#" class="btn btn-primary waves-effect waves-dark">Află mai multe</a>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
